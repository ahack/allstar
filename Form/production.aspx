            ...
            <asp:Panel ID="panel_title" runat="server">
                <table width="100%" style="border-style: double; background-color: #999966;">
                    <tr>
                        ...
                        <td class="style6">
                            <asp:Label ID="lbl_pros" runat="server" Text="State :" ForeColor="#993333"></asp:Label>
                    ...
                    <tr>
                        <td class="style7">
                            <asp:Label ID="lbl_state_text" runat="server" Text="State :" ForeColor="#993333"></asp:Label>
                            <asp:Label ID="lbl_state" runat="server" Font-Size="Large" Font-Underline="True"></asp:Label>
                        </td>
                        <td class="style6">
                            <asp:Label ID="lbl_county_text" runat="server" Text="County :" ForeColor="#993333"></asp:Label>
                            <asp:Label ID="lbl_county" runat="server" Font-Size="Large" Font-Underline="True"></asp:Label>
                        </td>
                        <td class="style7">
                            <asp:Label ID="lbl_product_text" runat="server" Text="Product :" ForeColor="#993333"></asp:Label>
                            <asp:Label ID="lbl_product" runat="server" Font-Size="Large" Font-Underline="True"></asp:Label>
                        </td>
                    ...
                    <tr>
                        ...
                        <td>Process time:</td>
                         <td class="style7"><div id="ProductionTimer" runat="server"> <script type="text/javascript" language="javascript" src="../Script/TimerClock.js"></script></div>
                         </td> 
                    </tr>
                </table>
            </asp:Panel>
                    ...
                    <table width="70%" style="background-color: #999966">
                        ...
                        <tr>
                            <td colspan="2" align="center">
                                ...
                                <asp:Button ID="btnmultiple" runat="server" Text="Sample Multiple" 
                                    onclick="btnmultiple_Click" />
